---
name: release-docs
description: "Post-ship documentation update. Cross-references the diff, updates README/ARCHITECTURE/CONTRIBUTING, polishes CHANGELOG, cleans TODOs."
category: documentation
tags: [docs, changelog, readme]
---
...
```bash
find . -maxdepth 2 -name "*.md" -not -path "./.git/*" -not -path "./node_modules/*" -not -path "././*" -not -path "./.context/*" | sort
```
...
(adapt to whatever project you're in — these are not -specific):
