...
description: "Designer's eye plan review (pre-implementation). Rates each design dimension 0-10 and fixes the plan to reach 10."
category: planning
tags: [review, design, ux]
---
...
`` (user config directory, not project files). The skill preamble
