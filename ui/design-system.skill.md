---
name: design-system
description: "Design consultation that proposes a complete design system: aesthetic, typography, color, layout, spacing, motion. Generates DESIGN.md."
category: ui
tags: [design, typography, color, css]
---
...
eval "$( 2>/dev/null)"
ls $SLUG/*office-hours* 2>/dev/null | head -5
