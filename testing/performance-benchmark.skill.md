...
description: "Performance regression detection. Establishes baselines for page load, Core Web Vitals, and bundle sizes, then compares before/after on every PR."
category: testing
tags: [performance, web-vitals, browser]
---
