---
name: visual-qa
description: "Designer's eye QA for visual inconsistency, spacing, hierarchy, and AI slop patterns. Iteratively fixes issues with before/after screenshot verification."
category: testing
tags: [design, visual, css, browser]
---
...
```
Write to: `{slug}/{user}-{branch}-design-audit-{datetime}.md`
