---
name: canary-monitor
description: "Post-deploy canary monitoring. Watches live app for console errors, performance regressions, and page failures with severity-based escalation."
category: deployment
tags: [monitoring, post-deploy, browser]
---
