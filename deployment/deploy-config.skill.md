---
name: deploy-config
description: "Configure deployment settings. Detects deploy platform (Fly.io, Render, Vercel, Netlify, Heroku, GitHub Actions), production URL, and health check endpoints."
category: deployment
...
# /setup-deploy — Configure Deployment for 
...
3. **How can  check if a deploy succeeded?**
