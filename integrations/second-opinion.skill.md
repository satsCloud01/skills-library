---
name: second-opinion
description: "Independent second opinion via OpenAI Codex. Three modes: code review (pass/fail gate), challenge (adversarial), and consult (Q&A)."
category: integrations
tags: [openai, codex, review]
---
...
```bash
 '{"skill":"codex-review","timestamp":"TIMESTAMP","status":"STATUS","gate":"GATE","findings":N,"findings_fixed":N,"commit":"'"$(git rev-parse --short HEAD)"'"}'
```
